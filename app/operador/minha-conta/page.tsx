...
export default function OperadorMinhaContaPage() {
      ...
      <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            ...
            type="submit"
            disabled={salvando}
            className="w-full py-2.5 bg-slate-700 text-white font-semibold rounded-xl hover:bg-slate-800 disabled:opacity-50 transition-colors text-sm mt-2"
          >
